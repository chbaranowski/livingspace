...
grails.project.groupId = livingspace // change this to alter the default package name and Maven publishing destination
...
environments {
    ...
    production {
        ...
        grails.serverURL = "http://www.wohnraum-kn.de"
    }
}
